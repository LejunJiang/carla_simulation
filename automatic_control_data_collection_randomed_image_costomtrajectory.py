    ...
    for data_number in range(0, 20):
        ...
        try:
            ...
            while True:
                ...
                # introduce random noise - random signal
                control.throttle += 0.4 * np.random.rand() - 0.2
                control.steer += 0.10 * np.random.rand() - 0.05

                if len(exported_data) >= 2500:
                    ...
                    df.to_pickle('_out/controller_data_image_818/Data_Collection_randomed_' + str(data_number) + '.pd')
                    break
